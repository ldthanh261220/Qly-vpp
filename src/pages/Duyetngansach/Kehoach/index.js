      ...
      <div className="plan-card__grid">
        <div>
          ...
          <div className="plan-card__field">
            ...
            <div className="plan-card__value">{plan.unit}</div>
          </div>
          <div className="plan-card__field">
            <div className="plan-card__label">Tổng ngân sách:</div>
            <div className="plan-card__value">{plan.sum}</div>
          </div>
        </div>
        <div>
          <div className="plan-card__field">
            <div className="plan-card__label">Lĩnh vực :</div>
            <div className="plan-card__value">{plan.field}</div>
          </div>
          <div className="plan-card__field">
            <div className="plan-card__label">Đại điểm :</div>
            <div className="plan-card__value">{plan.address}</div>
          </div>
