...
const Filter = ({setStatusFilter, statusFilter, contractStatus, setCurrentPage, setFieldFilter, searchTerm,
                fieldFilter, dateStart, dateEnd, setDateStart, setDateEnd, setSearchTerm
}) => {
  return (
