...
const SuaKeHoach = () => {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_BACKEND}getkehoach?maKeHoach=${id}`)
            .then((res) => {
                ...
                <table className="form-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="tenKeHoach" value={keHoach.tenKeHoach || ''} onChange={handleChange} />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    type="date"
                                    name="thoiGianBatDau"
                                    value={keHoach.thoiGianBatDau?.slice(0, 10) || ''}
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    value={keHoach.thoiGianKetThuc?.slice(0, 10) || ''}
                                    onChange={handleChange}
                                />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input name="chuBuTu" value={keHoach.chuBuTu || ''} onChange={handleChange} />
                            </td>
                        </tr>
